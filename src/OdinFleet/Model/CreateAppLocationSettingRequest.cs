...
namespace OdinFleet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "createAppLocationSetting_request")]
    public partial class CreateAppLocationSettingRequest : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAppLocationSettingRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateAppLocationSettingRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateAppLocationSettingRequest" /> class.
        /// </summary>
        ...
        public CreateAppLocationSettingRequest(string name = default(string), int serverConfigId = default(int), bool autoScalerEnabled = default(bool), int? autoScalerMin = default(int?), int? autoScalerMax = default(int?), int numInstances = default(int), Placement placement = default(Placement))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for CreateAppLocationSettingRequest and cannot be null");
            }
            this.Name = name;
        ...
        [DataMember(Name = "autoScalerMin", EmitDefaultValue = true)]
        ...
        [DataMember(Name = "autoScalerMax", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateAppLocationSettingRequest {\n");
