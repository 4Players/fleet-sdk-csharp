...
namespace OdinFleet.Model
{
    ...
    public partial class RestartPolicy : IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The condition for a restart</value>
        ...
        /// Initializes a new instance of the <see cref="RestartPolicy" /> class.
        /// </summary>
        /// <param name="condition">The condition for a restart (required).</param>
        public RestartPolicy(RestartPolicyCondition condition = default(RestartPolicyCondition))
        {
