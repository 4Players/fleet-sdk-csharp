...
namespace OdinFleet.Model
{
    ...
    /// </summary>
    [DataContract(Name = "updateDockerRegistry_request")]
    public partial class UpdateDockerRegistryRequest : IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDockerRegistryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateDockerRegistryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDockerRegistryRequest" /> class.
        /// </summary>
        ...
        /// <param name="instanceUrl">The URL of the instance.</param>
        /// <param name="username">The username to use for authentication.</param>
        /// <param name="accessToken">The access token to use for authentication.</param>
        /// <param name="password">The password to use for authentication.</param>
        public UpdateDockerRegistryRequest(DockerRegistryType type = default(DockerRegistryType), string name = default(string), string url = default(string), string instanceUrl = default(string), string username = default(string), string accessToken = default(string), string password = default(string))
        {
            this.Type = type;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for UpdateDockerRegistryRequest and cannot be null");
            }
            this.Name = name;
            this.Url = url;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateDockerRegistryRequest {\n");
